...
الحالة: **تصميم مقترح، غير منفذ**. تاريخ النقاش: 15 سبتمبر 2026. طلبت صاحبة المشروع حفظ القروب وتفضيلاته، والتصويت، وأكدت أن «رول» تشمل القرعة والأدوار معًا. قواعد التفصيل أدناه توصيات قابلة للتعديل؛ لم تُعتمد كتطبيق نهائي.
