...
ملاحظة توسعة: الرسم أدناه يقترح حسابات حول خطة واحدة لكل قروب. [مقترح القروبات الثابتة والطلعات](../proposals/persistent-groups.ar.md) يوسعه لاحقًا بفصل outings؛ عند اختيار تلك الميزة تصبح إعدادات الخطة والجيب والمكتمل مرتبطة بالطلعة بدل القروب. اعتمدي رسم المقترح لذلك النطاق، ولا تنفذي الرسمين كجدولين متكررين لنفس الحقيقة.
