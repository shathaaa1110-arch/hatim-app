...
النسخة المنفذة على الفرع `codex/persistent-groups`، 16 سبتمبر 2026. الواجهة React Native وExpo SDK 57، والخادم Python/FastAPI، وقاعدة البيانات PostgreSQL. نسخة .NET مستقلة ولم تتغير.
