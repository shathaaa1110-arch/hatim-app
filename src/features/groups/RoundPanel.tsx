...
export function RoundPanel({
  ...
  const drawing = async () => {
    ...
    try {
      await update(() => groupsApi.draw(token, round.id));
    } finally {
      animation.stop();
    ...
    <View style={{ gap: 18 }}>
        ...
        <Panel>
          ...
          {round.options.map((option) => (
            <View key={option.experience_id} style={{ gap: 6 }}>
              <Button
                ...
                onPress={() => {
                  void update(() =>
                    groupsApi.vote(token, round.id, option.experience_id),
                  ).catch(() => {});
                }}
              />
            </View>
          ...
          {round.can_vote && round.my_vote && (
            <Button
              ...
              disabled={busy}
              onPress={() => {
                void update(() => groupsApi.withdraw(token, round.id)).catch(
                  () => {},
                );
              }}
            />
            ...
            <Button
              ...
              onPress={() =>
                setConfirm({
                  ...
                  label: "إغلاق واعتماد",
                  run: () => update(() => groupsApi.resolve(token, round.id)),
                })
              }
            />
          )}
            ...
            <Button
              ...
              onPress={() =>
                setConfirm({
                  ...
                  label: "إلغاء الجولة",
                  run: () => update(() => groupsApi.cancel(token, round.id)),
                })
              }
            />
          )}
      ...
      >
        ...
        <Button
          ...
          onPress={() => {
            void update(() => groupsApi.round(token, o.id, mode, choices))
